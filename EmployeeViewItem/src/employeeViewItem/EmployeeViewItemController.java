...
public class EmployeeViewItemController implements Initializable {
	...
	EmployeeViewItemModel newModel = new EmployeeViewItemModel();
	...
	public void removeItem() {
		...
		try {
			Runtime.getRuntime().exec("java -jar \\H4HProject\\Runnables\\ItemRemoved.jar");
			Stage stage = (Stage)this.removeItem.getScene().getWindow();
			stage.close();
		} catch(Exception ex) {
			ex.printStackTrace();
		}
